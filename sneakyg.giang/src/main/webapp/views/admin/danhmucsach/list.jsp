...
<c:url var="LISTurl" value="/admin-danhmucsach" />
<!DOCTYPE html>
<html>
...
<body>
	...
	<script>
		...
		$("#btnDelete").click(function () {
			...
			data['ids'] = ids;
			deleteDanhMucSach(data);
		});

		function deleteDanhMucSach(data) {
			$.ajax({
				url: '${APIurl}',
				type: 'DELETE',
				...
				success: function (result) {
					window.location.href = "${LISTurl}?type=list&page=1&maxPageItem=5&sortName=tenDanhMuc&sortBy=asc";
				},
